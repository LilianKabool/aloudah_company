...
@injectable
class GetAllCustomersPaginatedCubit extends Cubit<PaginationStateTest<customerEntity>> {
      ...
      (r) {
        if (r.data != null) {
          ...
          emit(PaginationStateTest.success(
            data: _customers.where((element) => element != null).cast<customerEntity>().toList(),
  ...
  void _addIncomingDataToClassMemberData(
      bool loadMore, BasePaginationEntity<PaginationEntity<customerEntity?>> model) {
    if (loadMore) {
