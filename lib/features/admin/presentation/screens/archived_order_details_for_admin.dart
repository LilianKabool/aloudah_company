...
class ArchivedOrderDetailsForAdmin extends StatelessWidget{
  final String archived_source;
  final String archived_destination;
  final String  sender;
  ...
  const ArchivedOrderDetailsForAdmin({super.key, 
    required this.size ,
    required this.marks ,
    ...
    required this.archived_destination ,
    required this.archived_source ,
