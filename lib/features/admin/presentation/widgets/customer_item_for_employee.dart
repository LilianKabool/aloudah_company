...
import '../screens/customers_view_for_employee.dart';
...
class  CustomerItemForEmployee extends StatelessWidget{
  ...
  CustomerItemForEmployee({super.key});
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder:(context)=>const CustomersViewForEmployee()));
              },
              child: const Text(
                'View',
                style: TextStyle(
