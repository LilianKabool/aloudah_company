...
class EditEmployeeInformation extends StatefulWidget{
  const EditEmployeeInformation({super.key});
...
class _EditEmployeeInformationState extends State<EditEmployeeInformation> {
  ...
  void _editID() {
    TextEditingController employeeIdController = TextEditingController(text: employee_id);
    showDialog(
      context: context,
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeIdController.text = employee_id;
  ...
  void _editName() {
    TextEditingController employeeNameController = TextEditingController(text: employee_name);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeNameController.text = employee_name;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editMotherName() {
    TextEditingController employeeMotherNameController = TextEditingController(text: employee_mother_name);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: TextField(
            controller: employeeMotherNameController ,
            onChanged: (value) {
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeMotherNameController.text = employee_mother_name;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editBirthPlace() {
    TextEditingController employeeBPlaceController = TextEditingController(text: employee_b_place);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: TextField(
            controller: employeeBPlaceController ,
            onChanged: (value) {
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeBPlaceController.text = employee_b_place;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editPhone() {
    TextEditingController employeePhoneController = TextEditingController(text: employee_phone);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeePhoneController.text = employee_phone;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editMobile() {
    TextEditingController employeeMobileController = TextEditingController(text: employee_mobile);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeMobileController.text = employee_mobile;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editAddress() {
    TextEditingController employeeAddressController = TextEditingController(text: employee_address);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeAddressController.text = employee_address;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editRank() {
    TextEditingController employeeRankController = TextEditingController(text: employee_rank);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeRankController.text = employee_rank;
                Navigator.of(context).pop();
              },
            ),
          ],
  ...
  void _editSalary() {
    TextEditingController employeeSalaryController = TextEditingController(text: employee_salary);
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            FloatingActionButton(
              ...
              onPressed: () {
                ...
                employeeSalaryController.text = employee_salary;
                Navigator.of(context).pop();
              },
            ),
          ],
