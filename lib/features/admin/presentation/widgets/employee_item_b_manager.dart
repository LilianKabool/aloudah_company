...
import '../screens/view_employee_b_manager.dart';
...
class  EmployeeItemB_Manager extends StatelessWidget{
  ...
  EmployeeItemB_Manager({super.key});
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder:(context)=>const ViewEmployeeB_Manager()));
              },
              child: const Text(
                'View',
                style: TextStyle(
