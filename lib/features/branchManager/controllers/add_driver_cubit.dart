...
import '../data/params/add_driver_params.dart';
...
@injectable
class AddDriverCubit extends Cubit<PostState<BaseEntity>> {
  ...
  Future<void> emitAddDriver({required AddDriverParams addDriverParams}) async {
    emit(const PostState.loading());
    final response = await _branchManagerBaseRepository.addDriver(addDriverParams:addDriverParams);
