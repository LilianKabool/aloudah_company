            ...
            builder: (context, state) {
              return state.maybeWhen(
                idle: () {
                  return  TextButton(
                    onPressed: (){
                    //  context.read<AddTruckCubit>().emitAddTruck(addTruckParams: AddTruckParams(number: number, line: line, branchId: branchId))
                    },
                    child: Text(
                      'Add',
                      style: TextStyle(
                  ...
                  onTap: () {
                    showDatePicker(
                      ...
                      setState(() {
                        ...
                        widget.date_added =DateFormat('yyyy-MM-dd').format(widget.selectedDate);
