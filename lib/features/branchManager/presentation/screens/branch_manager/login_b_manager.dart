...
class LogInBMScreen extends StatelessWidget {
  final LogInController controller = Get.put(LogInController());
  final String guard;

  LogInBMScreen({super.key, required this.guard});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: BlocConsumer<LogInBMCubit,
                              PostState<LogInBMEntity>>(
                            listener: (context, state) {
                              state.whenOrNull(
                                success: (data) =>Navigator.pushReplacement(context,MaterialPageRoute(builder: (_)=> B_ManagerMainScreen())) ,
                                  ...
                                  onPressed: () async {
                                    if (controller.formKey.currentState!
                                      ...
                                      context
                                          .read<LogInBMCubit>()
                                          .emitLogInBM(
                                          logInbmParams: LogInBMParams(  name:
                                          controller
                                              .userNameController
                                              .text,
                                              password:
