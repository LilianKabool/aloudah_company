...
class opentripsManifestScreenForB_Manager extends StatefulWidget {
  final String manifestNumber;

  opentripsManifestScreenForB_Manager({required this.manifestNumber});

  @override
  State<opentripsManifestScreenForB_Manager> createState() =>
      _opentripsManifestScreenForB_ManagerState();
}

class _opentripsManifestScreenForB_ManagerState
    extends State<opentripsManifestScreenForB_Manager> {
  ...
  void initState() {
    ...
    cubit.emitGetManifest(
      getManifestBMParams: GetManifestBMParams(
        manifestNumber: widget.manifestNumber.toString(),
      ),
    );
  }
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(
                            'Manifest  ${widget.manifestNumber}',
                            style: TextStyle(
