...
part 'get_not_received_shipping_entity.g.dart';

@JsonSerializable()
class GetNotReceivedShippingEntity {
  @JsonKey(name: 'success')
  final bool success;
  @JsonKey(name: 'message')
  final String message; @JsonKey(name: 'data')

  final List<NotReceivedShipping> data;

  GetNotReceivedShippingEntity({
  ...
  factory GetNotReceivedShippingEntity.fromJson(Map<String, dynamic> json) => _$GetNotReceivedShippingEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetNotReceivedShippingEntityToJson(this);
}
@JsonSerializable()
class NotReceivedShipping {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory NotReceivedShipping.fromJson(Map<String, dynamic> json) => _$NotReceivedShippingFromJson(json);

  Map<String, dynamic> toJson() => _$NotReceivedShippingToJson(this);
}
