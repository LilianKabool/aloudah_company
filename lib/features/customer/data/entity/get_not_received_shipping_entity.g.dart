...
part of 'get_not_received_shipping_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetNotReceivedShippingEntity _$GetNotReceivedShippingEntityFromJson(
        Map<String, dynamic> json) =>
    GetNotReceivedShippingEntity(
      success: json['success'] as bool,
      message: json['message'] as String,
      data: (json['data'] as List<dynamic>)
          .map((e) => NotReceivedShipping.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$GetNotReceivedShippingEntityToJson(
        GetNotReceivedShippingEntity instance) =>
    <String, dynamic>{
...
NotReceivedShipping _$NotReceivedShippingFromJson(Map<String, dynamic> json) =>
    NotReceivedShipping(
      ...
      advance: json['advanced'] as String?,
...
Map<String, dynamic> _$NotReceivedShippingToJson(
        NotReceivedShipping instance) =>
    <String, dynamic>{
      'id': instance.id,
