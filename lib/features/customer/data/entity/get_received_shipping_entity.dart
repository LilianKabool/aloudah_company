...
part 'get_received_shipping_entity.g.dart';

@JsonSerializable()
class GetReceivedShippingEntity {
  @JsonKey(name: 'success')
  final bool success;
  @JsonKey(name: 'id')
  final String message;
  @JsonKey(name: 'data')
  final List<ReceivedShipping> data;

  GetReceivedShippingEntity({
    required this.success,
    required this.message,
    required this.data,
  });

  factory GetReceivedShippingEntity.fromJson(Map<String, dynamic> json) =>
      _$GetReceivedShippingEntityFromJson(json);

  Map<String, dynamic> toJson() => _$GetReceivedShippingEntityToJson(this);
}



@JsonSerializable()
class ReceivedShipping {
  @JsonKey(name: 'id')
  final int id;
  ...
  factory ReceivedShipping.fromJson(Map<String, dynamic> json) =>
      _$ReceivedShippingFromJson(json);

  Map<String, dynamic> toJson() => _$ReceivedShippingToJson(this);
}
