...
part of 'get_received_shipping_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetReceivedShippingEntity _$GetReceivedShippingEntityFromJson(
        Map<String, dynamic> json) =>
    GetReceivedShippingEntity(
      success: json['success'] as bool,
      message: json['id'] as String,
      data: (json['data'] as List<dynamic>)
          .map((e) => ReceivedShipping.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$GetReceivedShippingEntityToJson(
        GetReceivedShippingEntity instance) =>
    <String, dynamic>{
...
ReceivedShipping _$ReceivedShippingFromJson(Map<String, dynamic> json) =>
    ReceivedShipping(
      ...
      receiverNumber: json['reveiver_number'] as String,
...
Map<String, dynamic> _$ReceivedShippingToJson(ReceivedShipping instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'reveiver_number': instance.receiverNumber,
