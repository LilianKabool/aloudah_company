...
import 'package:aloudeh_company/features/admin/presentation/screens/admin_main_screen.dart';
...
import 'features/branchManager/presentation/screens/branch_manager/login_b_manager.dart';
        ...
        state.whenOrNull(
          success: (roleEntity) {
            ...
            if (role == 'employee') {
              ...
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (_) => B_ManagerMainScreen()));
            } else if (role == 'admin') {
              Navigator.of(context).pushReplacement(
...
class RoleSelectionScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            buildRoleCard(context, 'Branch Manager', Icons.business_center,
                Colors.orange, () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => LogInBMScreen(
                            guard: "branch_manager",
                          )));
                }),
            buildRoleCard(context, 'Admin', Icons.admin_panel_settings,
                Colors.blue, () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
            ...
            buildRoleCard(context, 'WH.Manager', Icons.warehouse, Colors.purple,
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => LogInWarehouseScreen(
  ...
  Widget buildRoleCard(BuildContext context, String role, IconData icon,
